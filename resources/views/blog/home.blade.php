            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a id="recentPosts" href="{{ route('getPublic', ['type'=>'recentPosts']) }}">Top 10 Most
                                Recent Posts</a></li>
                        {{--<li><a href="">Top 10 Liked Posts</a></li>--}}
                        <li><a id="commentedPosts" href="{{ route('getPublic', ['type'=>'mostCommented']) }}">Top 10
                                Most Commented Posts</a></li>
                        <li><a id="visitedPosts" href="{{ route('getPublic', ['type'=>'mostVisited']) }}">Top 10 Most
                                Visited Posts</a></li>
                    </ul>
                </li>
            </ul>
